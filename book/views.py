...
class ComparisonView(TemplateView):
    ...
    template_name = 'book/comparison.html'
...
class PoemDetailView(DetailView):
    ...
    model = Chapter
    template_name = 'book/poem_details.html'
...
class PoemListView(ListView):
    ...
    model = Chapter
    template_name = 'book/poem_list.html'
...
class SearchBooksView(TemplateView):
    ...
    template_name = 'book/search_books.html'
...
class SearchChaptersView(ListView):
    ...
    model = Chapter
    template_name = 'book/search_chapters.html'
...
class StudyDetailView(DetailView):
    ...
    model = Chapter
    template_name = 'book/study_details.html'
...
class StudyListView(ListView):
    ...
    model = Chapter
    template_name = 'book/study_list.html'
